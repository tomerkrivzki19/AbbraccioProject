...
// Exmaples of products to the cart
const products = [
  {
    id: 1,
                  ...
                  >
                    {products.map((product, productIdx) => (
                      ...
                      >
                        ...
                        />
                        <div className="mr-4 grid flex-auto grid-cols-1 grid-rows-1 items-start gap-x-5 gap-y-3 sm:ml-6 sm:flex sm:items-center sm:gap-0">
                          ...
                          <p className=" row-span-2 row-end-2 font-medium text-gray-900 sm:order-1 sm:ml-6 sm:w-1/3 sm:flex-none sm:text-left">
                            {product.price}
                          </p>
